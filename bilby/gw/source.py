...
def lal_binary_neutron_star_NEW(
    ...
    dQuadMon1 = dquadmon_from_lambda(lambda_1);
    dQuadMon2 = dquadmon_from_lambda(lambda_2);
    lalsim.SimInspiralWaveformParamsInsertdQuadMon1(wf_dict, dQuadMon1);
    lalsim.SimInspiralWaveformParamsInsertdQuadMon2(wf_dict, dQuadMon2);
