...
waveform_generator = bilby.gw.WaveformGenerator(
    ...
    frequency_domain_source_model=bilby.gw.source.lal_siqm,
...
ifos.set_strain_data_from_power_spectral_densities(
    sampling_frequency=sampling_frequency, duration=duration, start_time=injection_parameters['geocent_time'] - 3)
